...
public:
  ...
  void push_imu(deque<RosImuPtr> &imus)
  {
    ...
    {
      RosImu &imu1 = **(it_imu-1);
      RosImu &imu2 = **it_imu;

      double dt = ROS_TIMESTAMP_TO_SEC(imu2.header.stamp) - ROS_TIMESTAMP_TO_SEC(imu1.header.stamp);
